...
LittleFS_RAM myfs;  // will use dynamic allocation: SDRAM/PSRAM/RAM2
size_t fs_size = 6 * 1024 * 1024; // amount of memory to allocate for filesystem (won't fit in RAM2)
